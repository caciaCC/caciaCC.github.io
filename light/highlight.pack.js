...
;for(let a=0;a<e.length;a++){s+=1;const i="s;let" o="u(e[a])" ;for(a>0&&(r+=t),r+="(";o.length>0;){const e=n.exec(o);if(null==e){r+=o;break}
...
return e.length&&t.length?e[0].offset!==t[0].offset?e[0].offset<t[0].offset?e:t:"start"===t[0].event?e:t:e.length?e:t }function l(e){a+="<" +p(e)+[].map.call(e.attributes,(function(e){ return" "+e.nodename+'="'+r(e.value)+'" '})).join("")+">"}function c(e){
a+=""}function u(e){("start"===e.event?l:c)(e.node)}
...
excludeEnd:!0,starts:{endsWithParent:!0,illegal:"[<=$]",relevance:0,contains:s} }]},d="{className:"keyword"," begin:"@(import|media|charset|font-face|(-[a-z]+-)?keyframes|supports|document|namespace|page|viewport|host)\\b", starts:{end:"[;{}]",returnend:!0,contains:s,relevance:0}},o="{" classname:"variable",variants:[{begin:"@[\\w-]+\\s*:",relevance:15},{ begin:"@[\\w-]+"}],starts:{end:"[;}]",returnend:!0,contains:c}},b="{variants:[{" begin:"[\\.#:&\\[>]",end:"[;{}]"},{begin:n,end:/\{/}],returnBegin:!0,
returnEnd:!0,illegal:"[<='$\"]",relevance:0, contains:[e.c_line_comment_mode,e.c_block_comment_mode,l,r("keyword","all\\b"),r("variable","@\\{[\\w-]+\\}"),r("selector-tag",n+"%?",0),r("selector-id","#"+n),r("selector-class","\\."+n,0),r("selector-tag","&",0),{ classname:"selector-attr",begin:"\\[",end:"\\]"},{classname:"selector-pseudo", begin: :(:)?[a-za-z0-9_\-+()"'.]+ },{begin:"\\(",end:"\\)",contains:c},{ begin:"!important"}]} ;return a.push(e.c_line_comment_mode,e.c_block_comment_mode,d,o,g,b),{ name:"less",case_insensitive:!0,illegal:"[>'/<($\"]",contains:a}}})());hljs.registerLanguage("lua",(()=>{"use strict";return e=>{
...
name:"SQL",case_insensitive:!0,illegal:/[{}]|<\ ,keywords:{ $pattern: \b[\w\.]+ ,keyword:((e,{exceptions:r,when:t}="{})=">{const n=t
;return r=r||[],e.map((e=>e.match(/\|\d+$/)||r.includes(e)?e:n(e)?e+"|0":e))
})(l,{when:e=>e.length<3}).join(" "),literal:a.join(" "),type:i.join(" "), built_in:"current_catalog current_date current_default_transform_group current_path current_role current_schema current_transform_group_for_type current_user session_user system_time system_user current_time localtime current_timestamp localtimestamp" },contains:[{begin:t(...o),keywords:{$pattern: [\w\.]+ , keyword:l.concat(o).join(" ")}},{ classname:"type", begin:t("double precision","large object","with timezone","without timezone") },u,{classname:"variable",begin: @[a-z0-9]+ },{classname:"string",variants:[{ begin: ' ,end: ,contains:[{begin: '' }]}]},{begin: " ,contains:[{ "" }]},e.c_number_mode,e.c_block_comment_mode,n,{classname:"operator", [-+* =%^~]|&&?|\|\|?|!="?|<(?:=">?|<|>)?|>[>=]?/,relevance:0}]}}})());hljs.registerLanguage("csharp",(()=>{"use strict";return e=>{var n={
...
literal:"true false Some None Ok Err",built_in:t},illegal:""}]}}})());hljs.registerLanguage("go",(()=>{"use strict";return e=>{const n={
keyword:"break default func interface select case map struct chan else goto package switch const fallthrough if range type continue for import return var go defer bool byte complex64 complex128 float32 float64 int8 int16 int32 int64 string uint8 uint16 uint32 uint64 int uint uintptr rune",
literal:"true false iota nil",
built_in:"append cap close complex copy imag len make new panic print println real recover delete"
};return{name:"Go",aliases:["golang"],keywords:n,illegal:"{"use strict";return s=>({
...
disableAutodetect:!0,illegal:"",keywords:u,contains:["self",s]},{begin:t.IDENT_RE+"::",keywords:u},{
...
},b=(r=>{const c=e,o={begin:/<[A-Za-z0-9\\._:-]+ , end: \ [a-za-z0-9\\._:-]+>|\/>/,isTrulyOpeningTag:(e,n)=>{
...
begin://,keywords:_,contains:[...N,...j,B,K]};K.contains.push(P)
...
begin:/[A-Za-z$_][0-9A-Za-z$_]*/}),{begin://},{className:"params",
...
begin:e(/[a-zA-Z][a-zA-Z_0-9]*/,"\\s+<-\\s+")},{begin:"`",end:"`",contains:[{ begin: \\. }]}]}}})());hljs.registerlanguage("javascript",(()>{"use strict"
;const e="[A-Za-z$_][0-9A-Za-z$_]*",n=["as","in","of","if","for","while","finally","var","new","function","do","return","void","else","break","catch","instanceof","with","throw","case","default","try","switch","continue","typeof","delete","let","yield","const","class","debugger","async","await","static","import","from","export","extends"],a=["true","false","null","undefined","NaN","Infinity"],s=[].concat(["setInterval","setTimeout","clearInterval","clearTimeout","require","exports","eval","isFinite","isNaN","parseFloat","parseInt","decodeURI","decodeURIComponent","encodeURI","encodeURIComponent","escape","unescape"],["arguments","this","super","console","window","document","localStorage","module","global"],["Intl","DataView","Number","Math","Date","String","RegExp","Object","Function","Boolean","Error","Symbol","Set","Map","WeakSet","WeakMap","Proxy","Reflect","JSON","Promise","Float64Array","Int16Array","Int32Array","Int8Array","Uint16Array","Uint32Array","Float32Array","Array","Uint8Array","Uint8ClampedArray","ArrayBuffer"],["EvalError","InternalError","RangeError","ReferenceError","SyntaxError","TypeError","URIError"])
...
end:/$/,keywords:{$pattern:/[\.\w]+/,"meta-keyword":".PHONY"}},r]}}})());</\></\?(php|=)?></\></\></\></script(?=\s|></\></style(?=\s|></\?xml></"!==s?"></[A-Za-z0-9\\._:-]+></-\\s+")},{begin:"`",end:"`",contains:[{></"!==s?"></[A-Za-z0-9\\._:-]+></.*?></[^<></"+a+"></%[%=-]?",end:"[%-]?%></.*?></[^<></[></\?php></\></-?\s*(?=\w+)></\></\></\></.+></.+></"+e.IDENT_RE+"(\\s*,\\s*"+e.IDENT_RE+")*></",end:"></|></3}).join("></\></[-~]?'?(\w+)\n(?:[^\n]*\n)*?\s*\1\b></",end:"></=></|></\(,]|$></($\"]",contains:a}}})());hljs.registerLanguage("lua",(()=></='$\"]",relevance:0,></=$]",relevance:0,contains:s}></",end:"></[^></br[></unnamed></[^></t[0].offset?e:t:"start"===t[0].event?e:t:e.length?e:t></e.length;a++){s+=1;const></|<<=|<=|<|===|==|=|></span>